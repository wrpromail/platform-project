...
public class Swagger2Controller {
    ...
    public static final String DEFAULT_URL = "/v2/api-docs2";
    ...
    public String getDocumentation(
        ...
        sb.append("| 描述  | 方法      | 路径      | notes  |\n");
        sb.append("| ---- | ---- | ---- | ---- |\n");
        Multimap<String, ApiListing> apiListings = documentation.getApiListings();

        apiListings.values().forEach(s -> s.getApis().forEach(p -> {
            String path = p.getPath();
            // String description = p.getDescription();
            p.getOperations().forEach(o -> {
                HttpMethod method = o.getMethod();
                String summary = o.getSummary();
                String notes = o.getNotes();
                if (!o.isHidden() && "false".equals(o.getDeprecated())) {
                    sb.append("|").append(summary).append("|").append(method).append("|").append(path).append("|").append(notes).append("|\n");
                }
            });
        }));
