...
import net.coding.platform.ram.event.group.user.GroupUserDeletedEvent;
...
public class GroupUserDeletedEventListener {
    ...
    public void handle(GroupUserDeletedEvent event) {
        try {
            ...
            log.error("DepartmentDeleteEvent Error, teamId = {}, groupId = {}, userId = {}, message = {}",
